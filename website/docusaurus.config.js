...
const config = {
  title: 'Marco Carvalho',
  tagline: 'Compartilhando experiências em tecnologia',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        //   },
        // ],
        copyright: `Copyright © ${new Date().getFullYear()} Marco Carvalho. Desenvolvido com Docusaurus.`,
      },
      prism: {
